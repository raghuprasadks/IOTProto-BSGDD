...
import mailnotification_final as mf
...
lang =13.0731511
lat = 77.616761
sub = "Garbage dump detected @"
body = "Garbage dump detected. Please find the attached image for your kind reference"
    ...
    # Load all the images
        ...
        # 2) Check for similarities between the 2 images
            ...
            if (isGarbageDetected):
                mf.sendMail(sub,body,write_name,lang,lat)
                break
